...
exports.setMidnightConnection = setMidnightConnection;
exports.closePosition = closePosition;
exports.closeAllPositions = closeAllPositions;
exports.startMidnightCheck = startMidnightCheck;
const state_1 = require("../state");
let connection = null;
function setMidnightConnection(conn) {
    connection = conn;
}
...
async function closePosition(positionId) {
    ...
    try {
        ...
        state_1.state.positions.delete(positionId);
        return true;
    }
    catch (err) {
...
async function closeAllPositions() {
    const ids = [...state_1.state.positions.keys()];
    if (ids.length === 0)
        return { closed: 0, failed: 0 };
    let closed = 0;
    let failed = 0;
    for (const positionId of ids) {
        if (await closePosition(positionId))
            closed++;
        else
            failed++;
    }
...
//# sourceMappingURL=midnightClose.js.map